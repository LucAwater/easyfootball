...
<div id="payment" class="woocommerce-checkout-payment">
    ...
    <!-- Terms and conditions -->
		<small><?php _e('Genom att klicka "Jag godkänner" godkänner du användaravtalet och accepterar att köpet innebär ett betalningsansvar.'); ?> <a href="/anvandarvillkor" target="_blank"><?php _e('Läs Easyfootball användaravtal här'); ?></a></small>
